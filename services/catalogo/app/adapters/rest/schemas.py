...
class DireccionPuntoVentaResponse(BaseModel):
    """Dirección resuelta vía Identidad (composición síncrona en lectura)."""
    id: uuid.UUID
    calle: str
    numero: str
    ciudad: str
...
# --- Contratos inter-servicio (comandos de stock de la saga de checkout) ---
# Espejan services/shared/contracts/catalogo.py (el build de Docker solo copia app/)
